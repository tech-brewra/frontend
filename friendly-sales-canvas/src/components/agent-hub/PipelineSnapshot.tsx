...
//   const [availableTimeframes, setAvailableTimeframes] = useState<string[]>(['7', '15', '30', '60']);
...
//       if (!data || !data.timeframes || !Array.isArray(data.timeframes)) {
//         console.error('❌ Invalid API response structure:', data);
//         throw new Error('Invalid API response format');
//       }
      
//       // Extract available timeframes from API response
//       const availableTimeframes = extractAvailableTimeframes(data);
//       setAvailableTimeframes(availableTimeframes);
      
//       // Process the data for the selected timeframe
//       const formattedData = processApiData(data, selectedTimeframe);
