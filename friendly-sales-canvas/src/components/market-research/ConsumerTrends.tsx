...
// //     // { key: 'Demo Scheduled', title: 'Demo Scheduled', color: 'bg-green-50 border-green-200' },
// //     // { key: 'Qualified', title: 'Qualified', color: 'bg-purple-50 border-purple-200' },
// //     { key: 'Discovery', title: 'Discovery', color: 'bg-orange-50 border-orange-200' },
// //     { key: 'Prospecting', title: 'Prospecting', color: 'bg-teal-50 border-teal-200' },
// //     { key: 'Technical Fit', title: 'Technical Fit', color: 'bg-indigo-50 border-indigo-200' },
// //     { key: 'Demo', title: 'Demo', color: 'bg-pink-50 border-pink-200' },
// //     { key: 'Qualification', title: 'Qualification', color: 'bg-cyan-50 border-cyan-200' }
// //   ];
...
// //       case 'Technical Fit': return 'outline';
...
// //             <span>Loading leads from API...</span>
// //           </div>
// //         </CardContent>
// //       </Card>
// //     );
...
//       <CardContent className="p-4">
//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4" style={{gridTemplateColumns: `repeat(${Math.min(statusColumns.length, 4)}, minmax(0, 1fr))`}}>
//           {statusColumns.map((column) => (
//             <div key={column.key} className={`rounded-lg border-2 ${column.color} p-3`}>
//               <div className="flex items-center justify-between mb-3">
//                 <h3 className="font-semibold text-sm">{column.title}</h3>
